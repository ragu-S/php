...
class FormUserRegisteration {
    ...
    public function __construct() {
        //Radio
        $this->title = new RadioButton("title");
        ...
        $this->email->setRegEx("/(^\s*$)|([^@a-z\-;\:\,\.\'0-9\s])/i");
        $this->phone = new ItemEntry("phone");
        $this->phone->setRegEx("/([^0-9- ]|^[^0-9]{9}$|^\s*$)/");
        ...
        //$this->tuesday->setRegEx("/[^monday]/");
        $this->tuesday = new CheckBox("tuesday");
        //$this->tuesday->setRegEx("/[^tuesday]/");

        //Select Option
        $this->tShirt = new SelectField("tShirt");
